...
[^integrated]: Since Zensical is a vertically integrated set of different projects that have their own repositories, we integrate all change requests into the backlog, which allows us to keep track of change requests across all projects.
