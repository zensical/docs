...
- **Keep it short** – be brief and to the point when describing your idea,
...
:lucide-cake: **Stretch goal** – if you have a customization or another
...
> **Why we need this**: To understand and evaluate your proposed change, we need
...
> **Why we need this**: Related links help us gain a comprehensive understanding
...
**You can drag and drop the files into the text area or include links to
external assets.**
...
**Your change request got rejected? We're sorry for that.** We understand it can
...
[^1]: We might be using terminology in our documentation different from yours, but we mean the same. When you include the search terms and related links in your change request, you help us to adjust and improve the documentation.
